...
class DeltaTextInputService extends TextInputService with DeltaTextInputClient {
  ...
  // DaiDai側の変更（2026-09-06）: 使用中のFlutter SDKが`TextInputClient`に
  // 追加した`onFocusReceived`（appflowy_editor 6.2.0公開時点のFlutter SDKには
  // 無かったメンバー）への対応。既定値（フォーカス受信を消費しない）と同じ
  // `false`を返す。
  @override
